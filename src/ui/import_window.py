...
class ImportWindow:
    ...
    def create_widgets(self):
        ...
        # Título e status com tema escuro
        header_frame = ttk.Frame(main_frame, style='Dark.TFrame')
        header_frame.grid(row=0, column=0, sticky=(tk.W, tk.E), pady=(0, 20))
        header_frame.columnconfigure(1, weight=1)
        
        title_label = ttk.Label(header_frame, 
                               text="📥 Importação de Dados - DAC System", 
        ...
        # Botões de seleção com tema escuro
        buttons_row1 = tk.Frame(files_frame, bg='#21262D')
        buttons_row1.grid(row=0, column=0, columnspan=2, sticky=(tk.W, tk.E), 
                         pady=(15, 15), padx=20)
        
        # Usar tk.Button com tema escuro em vez de ttk.Button
        btn_csv = tk.Button(buttons_row1, text="📄 CSV (Ctrl+O)", 
        ...
        btn_excel = tk.Button(buttons_row1, text="📊 Excel (Ctrl+E)", 
        ...
        btn_clear = tk.Button(buttons_row1, text="🗑️ Limpar (Del)", 
        ...
        btn_refresh = tk.Button(buttons_row1, text="🔄 Atualizar (F5)", 
