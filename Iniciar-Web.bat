...
:: ============================================================================
:: Iniciar Versao Web - Sistema DAC (robusto)
:: - Usa Python do venv se existir
:: - Abre duas janelas (backend e frontend) e mantem esta
:: ============================================================================
...
set LAUNCHER=scripts\inicializacao\launcher_web.py
...
echo.
if %RC% NEQ 0 (
    echo ❌ Falha ao iniciar a Versao Web. Codigo: %RC%
    echo    Dica: rode primeiro setup.bat ou Iniciar-Tudo.bat.
) else (
    echo ✅ Launcher Web concluido.
)
echo.
pause
endlocal
